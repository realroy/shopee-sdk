...
export type CancelOrderRequestParameters = z.infer<
  typeof cancelOrderRequestParametersSchema
>;
export type CancelOrderRespone = z.infer<typeof cancelOrderResponseSchema>;

export type HandleBuyerCancellationRequestParameters = z.infer<
  typeof handleBuyerCancellationRequestParametersSchema
>;
export type HandleBuyerCancellationResponse = z.infer<
  typeof handleBuyerCancellationResponseSchema
>;

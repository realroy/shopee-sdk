...
export const API_V2_LOGISTIC_GET_SHIPPING_DOCUMENT_PARAMETER =
  "/api/v2/logistic/get_shipping_document_parameter";
export const API_V2_LOGISTIC_CREATE_SHIPPING_DOCUMENT =
  "/api/v2/logistic/create_shipping_document";
export const API_V2_LOGISTIC_GET_SHIPPING_DOCUMENT_RESULT =
  "/api/v2/logistics/get_shipping_document_result";
export const API_V2_LOGISTIC_DOWNLOAD_SHIPPING_DOCUMENT = '/api/v2/logistics/download_shipping_document'
...
export const V2_LOGISTIC_SHIPPING_STATUSES = ["READY", "FAILED", "PROCESSING"] as const;
